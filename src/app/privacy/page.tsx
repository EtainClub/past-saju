  ...
  return (
    <main className={styles.page}>
      ...
      <p>
        ...
        제공합니다. 서비스 이용에는 로그인이 필요하지 않으며, 입력한 내용은 기본적으로 <strong>7일</strong> 뒤 자동으로
        삭제됩니다. 이용자가 직접 <strong>보관을 선택한 경우에만</strong> 구글 계정과 연결해 <strong>1년</strong>간
        보관합니다.
      </p>

      <h2>1. 수집하는 정보</h2>
      <p>해석에 필요한 아래 항목만 이용자가 직접 입력합니다.</p>
      <table>
        <thead>
      ...
      <p>
        <strong>자동으로 부여되는 식별자:</strong> 이용 통계와 과도한 요청 방지를 위해 접속 시 익명 식별자를 자동으로
        발급합니다. 이 식별자만으로는 이용자가 누구인지 알 수 없으며, 브라우저 저장소를 비우면 사라집니다.
      </p>
      <p>
        <strong>보관을 선택한 경우:</strong> 이용자가 결과 화면에서 &ldquo;보관하기&rdquo;를 선택하면 구글 계정과
        연결되며, 이때 구글이 제공하는 <strong>계정 식별자와 표시 이름</strong>을 받습니다. 보관을 선택하지 않으면
        구글 계정과 연결되지 않습니다.
      </p>
      <p>
        <strong>수집하지 않는 정보:</strong> 연락처, 정확한 주소, 결제 정보를 수집하지 않습니다.
      ...
      <ul>
        ...
        <li>익명 식별자: 이용 통계 집계와 요청 횟수 제한</li>
        <li>구글 계정 식별자: 보관을 선택한 기록을 본인에게만 다시 보여주기 위한 확인</li>
      ...
      <ul>
        ...
        <li>
          이용자가 직접 <strong>보관을 선택한 기록만 1년</strong>간 보관한 뒤 같은 방식으로 파기됩니다. 구글 계정을
          연결한 것만으로는 보관 기간이 늘어나지 않으며, <strong>보관하기를 선택한 기록에만</strong> 적용됩니다.
        </li>
